 ...
 * 
 */
@WebServiceClient(name = "Server", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/Server/Server?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Server/Server?wsdl");
